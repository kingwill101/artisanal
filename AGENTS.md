...
| `pkgs/artisanal_capture` | `artisanal_capture` 0.1.x | Reusable cell captures, native PNG exports, widget scenarios, and an Artisanal-based CLI. Raster rendering belongs to `ultraviolet`. |
