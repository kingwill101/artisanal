...
void main() {
  ...
  for (final width in [80, 112]) {
    test('issue table survives F12 and remains scrollable at $width columns', () async {
      const height = 40;
      ...
      for (final offset in [0, 8, 24]) {
        ...
        expect(visibleOutput, isNot(contains('dart-review.googlesource.com')));
        expect(
          tester.view,
          baseline,
        ...
        expect(Style.stripAnsi(tester.rendererOutput), isNot(contains(']8;;')));
      }
