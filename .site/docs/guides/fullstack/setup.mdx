...
To make database access consistent across our app and tests, we wrap the `DataSource` in a helper class. This class handles the connection lifecycle and ORM bootstrapping.
