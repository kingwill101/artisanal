      ...
      expect(
        ...
        equals(
          [
            ...
            '  -v, --verbose              Increase verbosity of messages: 1 for normal output,',
      ...
      expect(
        ...
        equals(
          [
            ...
            '\x1b[93m\x1b[1mUsage:\x1b[m',
            '  orm <command> [arguments]',
            '',
            '\x1b[93m\x1b[1mOptions:\x1b[m',
            ...
            '  \x1b[92m-v, --verbose\x1b[m              Increase verbosity of messages: 1 for normal output,',
            '                             2 for more verbose output and 3 for debug.',
            '      \x1b[92m--completion-script\x1b[m    Print a shell completion script to stdout.',
            '',
            '\x1b[93m\x1b[1mAvailable commands:\x1b[m',
            '  \x1b[92mapply\x1b[m            Apply pending migrations.',
            '',
            '\x1b[93m\x1b[1mschema\x1b[m',
            '  \x1b[92mschema:describe\x1b[m  Describe schema.',
            '  \x1b[92mschema:dump\x1b[m      Dump schema.',
            '',
            'Run \x1b[1m"orm <command> --help"\x1b[m for more information about a command.',
          ].join('\n'),
        ),
      );
    });
