...
class AnsiRendererOptions {
  ...
  /// Maximum code block size eligible for syntax highlighting.
  ///
  /// Large GitHub issue and pull request bodies can contain long generated
  /// snippets. Keeping them as styled code blocks but skipping tokenization
  /// avoids spending interactive scroll time in `highlight.dart`. Set to null
  /// to highlight code blocks regardless of size.
