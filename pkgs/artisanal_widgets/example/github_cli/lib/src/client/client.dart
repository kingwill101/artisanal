...
final class GhCliClient
  ...
  Stream<GithubPullRequestDiffChunk> loadPullRequestDiffChunks({
    ...
    while (true) {
      ...
      // Give the TUI loop a chance to render progress between large pages.
...
const _pullRequestsPageQuery = r'''
