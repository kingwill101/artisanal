// Web-safe exports only. IO-only app files (runner, replay, view_command,
// profile_harness, profile_regions, client_cli) are in app_io.dart, used exclusively from bin/.
